...
export default function LevelPage() {
  ...
  return (
    <div className="min-h-screen bg-black overflow-x-hidden">
      {/* Header navigation */}
      <header className="bg-zinc-950 shadow-lg border-b-2 border-zinc-800 pt-safe">
        <div className="max-w-6xl mx-auto px-3 sm:px-4 py-3 sm:py-4">
          <div className="flex items-center justify-between gap-2">
            {/* Logo - icon only on mobile, full on desktop */}
            <Link
              href="/"
              className="flex items-center gap-2 sm:gap-3 text-xl sm:text-3xl font-logo text-white hover:text-[#00d9ff] transition-colors tracking-wide flex-shrink-0"
            >
              <svg width="28" height="28" viewBox="0 0 1200 1200" className="fill-zinc-600 sm:w-8 sm:h-8">
              ...
              <span className="hidden sm:inline">DRUMMER.</span>
            </Link>
            ...
            <nav className="flex gap-1 sm:gap-2">
              <Link
                href="/"
                className="px-3 sm:px-4 py-2 rounded-lg font-bold transition-all text-sm sm:text-lg bg-zinc-900 text-zinc-400 hover:bg-zinc-800 hover:text-[#00ff88]"
              >
                Home
              </Link>
              <Link
                href="/levels/1"
                className="px-3 sm:px-4 py-2 rounded-lg font-bold transition-all text-sm sm:text-lg bg-[#00d9ff] text-black"
              >
                Level 1
              </Link>
              <Link
                href="/patterns"
                className="px-3 sm:px-4 py-2 rounded-lg font-bold transition-all text-sm sm:text-lg bg-zinc-900 text-zinc-400 hover:bg-zinc-800 hover:text-[#ff9100]"
              >
                Patterns
              </Link>
            </nav>
